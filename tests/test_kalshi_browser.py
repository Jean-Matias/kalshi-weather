...
class KalshiBrowserTests(unittest.TestCase):
    def test_parse_bucket_contracts_and_select_highest_yes_price(self):
        text = """
Highest temperature in San Francisco today?
76%
61° or below
Yes 1¢
No
...
No
Market Rules
If the maximum temperature recorded at San Francisco for May 24, 2026, is between 66-67° fahrenheit according to the National Weather Service's Climatological Report (Daily), then the market resolves to Yes.
"""
