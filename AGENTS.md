# kalshi-weather-scout Agent Instructions

## Project Purpose

This project is a research-only MVP for Kalshi daily high-temperature markets.
...
- Read `docs/AI_CONTEXT.md` for the compact project map, safety states, and
  Chicago miss regression context before making non-trivial changes.
